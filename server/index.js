  ...
  server.get('/api/docs', (req, res) => {
    res.json({
      ...
      endpoints: [
        ...
        { method: 'GET', path: '/api/projects/templates', description: 'List available project templates' },
        { method: 'POST', path: '/api/projects', description: 'Create project', body: '{ name, path, description, ignore_patterns, project_template, project_manager_agent_id, main_developer_agent_id }' },
        ...
        { method: 'POST', path: '/api/settings/provider-auth/openai-codex/login', description: 'Start OpenAI Codex browser OAuth login' },
        { method: 'GET', path: '/api/settings/provider-auth/openai-codex/login/:flowId', description: 'Get OpenAI Codex OAuth flow status' },
        { method: 'POST', path: '/api/settings/provider-auth/openai-codex/login/:flowId/complete', description: 'Complete OpenAI Codex OAuth manually', body: '{ authorization_response }' },
        { method: 'POST', path: '/api/settings/provider-auth/openai-codex/import', description: 'Import existing Codex OAuth from ~/.codex/auth.json' },
